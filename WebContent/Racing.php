...
$query = "SELECT * FROM `points` as points left OUTER JOIN gamers as gamers on gamers.gamer_id = points.gamer_id WHERE points.category_id = 2 and points.round =".$_GET['round']."";
